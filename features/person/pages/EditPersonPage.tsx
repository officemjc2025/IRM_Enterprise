...
export default function EditPersonPage({ params }: EditPersonProps) {
  ...
  useEffect(() => {
    const fetchPerson = async () => {
      try {
        ...
        if (json.success) {
          setPersonCode(json.data.person_code || "");
          ...
          setDateOfBirth(json.data.date_of_birth || "");
          setNationality(json.data.nationality || "");
          setPhone(json.data.phone || "");
          setEmail(json.data.email || "");
          setIdCard(json.data.id_card || "");
